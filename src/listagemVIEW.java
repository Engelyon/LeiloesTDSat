...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (idText.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor, digite o ID do produto para vender.", "Aviso", JOptionPane.WARNING_MESSAGE);
            return;
        }
        try {
            Integer idFinal = Integer.valueOf(idText);
            ProdutosDAO produtosdao = new ProdutosDAO();
            produtosdao.venderProduto(idFinal);
            listarProdutos();
            id_produto_venda.setText("");

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "O ID do produto deve ser um número válido.", "Erro de Entrada", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao tentar vender o produto: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
